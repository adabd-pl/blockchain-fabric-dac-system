...
createMSPPeer0() {
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:6054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/msp --csr.hosts peer0.org3.example.com --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  sleep 2
  ...
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:6054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/peers/peer0.org3.example.com/tls --enrollment.profile tls --csr.hosts peer0.org3.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
...
createMSPPeer1() {
  ...
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:6054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/peers/peer1.org3.example.com/msp --csr.hosts peer1.org3.example.com --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  ...
  fabric-ca-client enroll -u https://peer1:peer1pw@localhost:6054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/peers/peer1.org3.example.com/tls --enrollment.profile tls --csr.hosts peer1.org3.example.com --csr.hosts localhost --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  sleep 2
...
generateUserMSP() {
  ...
  fabric-ca-client enroll -u https://user1:user1pw@localhost:6054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
  sleep 2
...
generateAdminMSP() {
  ...
  fabric-ca-client enroll -u https://org3admin:org3adminpw@localhost:6054 --caname ca.org3.example.com -M ${PWD}/crypto-config-ca/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp --tls.certfiles ${PWD}/fabric-ca/org3/tls-cert.pem
...
mv "$(pwd)/crypto-config-ca/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp/keystore/"* "$(pwd)/crypto-config-ca/peerOrganizations/org3.example.com/users/User1@org3.example.com/msp/keystore/priv_sk"
mv "$(pwd)/crypto-config-ca/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp/keystore/"* "$(pwd)/crypto-config-ca/peerOrganizations/org3.example.com/users/Admin@org3.example.com/msp/keystore/priv_sk"